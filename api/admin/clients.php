...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $query = "SELECT u.id, u.username, u.full_name, u.country, u.state, u.city, u.company_name,
    ...
    if(!empty($data->username) && !empty($data->password)) {
        ...
        $query = "INSERT INTO users (username, password, full_name, country, state, city, company_name, role)
                  VALUES (:username, :password, :full_name, :country, :state, :city, :company_name, 'client')";
        $stmt = $db->prepare($query);
